export default function Bar(){
    ...
    return(
        <div className="bg-slate-200 max-w-min mx-auto px-8 pb-8 rounded-lg">
        ...
        <div className="flex flex-row justify-center bg-white p-2 rounded-full">
            <div className="mx-2">
                <div className="flex justify-between">
                    <div className="text-white p-8 rounded-full bg-yellow-500 shadow-lg">
            ...
            <div className="mx-2">
                <div className="flex justify-between">
                    <div className="text-white p-8 rounded-full bg-red-600 shadow-lg">
            ...
            <div className="mx-2">
                <div className="flex justify-between">
                    <div className="text-white p-8 rounded-full bg-green-600 shadow-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-10 h-10">
